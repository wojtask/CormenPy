...
class TestExercise11_1_4(TestCase):
    ...
    def test_huge_array_search(self):
        max_value = 20
        huge_array, stack_array, keys = get_random_huge_array(max_value=max_value)
    ...
    def test_huge_array_insert(self):
        huge_array, stack_array, keys = get_random_huge_array()
        ...
        # also make sure there is a space in stack_array for the new element
        ...
        assert_that(stack_array[1:stack_array.top],
                    contains_inanyorder(*original_stack_array[1:original_stack_array.top], new_element))
    ...
    def test_huge_array_delete(self):
        ...
        assert_that(stack_array[1:stack_array.top],
                    contains_inanyorder(*original_stack_array[1:original_stack_array.top]))
        assert_huge_array_consistent(huge_array, stack_array)
