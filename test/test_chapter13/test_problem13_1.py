...
from tree_util import assert_binary_search_tree, get_binary_tree_inorder_keys, assert_red_black_tree, \
...
class TestProblem13_1(TestCase):
    ...
    def test_persistent_tree_insert(self):
        ...
        for i, key in enumerate(keys, start=1):
            ...
            actual_keys_before_insertion = get_binary_tree_inorder_keys(tree)
            actual_keys_after_insertion = get_binary_tree_inorder_keys(new_tree)
